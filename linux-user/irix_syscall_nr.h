...
#define TARGET_NR_wait  		(TARGET_NR_Linux +   7)
...
#define TARGET_NR_stat  		(TARGET_NR_Linux +  18)
...
#define TARGET_NR_getdents		(TARGET_NR_Linux +  81)
...
#define TARGET_NR_sysinfo		(TARGET_NR_Linux + 156)
...
#define TARGET_NR_waitsys		(TARGET_NR_Linux + 170)
